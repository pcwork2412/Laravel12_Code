    ...
    public function store(Request $request)
    {
        try {
            ...
            $data = $request->validate([
                ...
                'mother_mobile'           => 'required|string|max:115',
                'father_mobile'           => 'required|string|max:115',
                'present_address'         => 'required|string|max:255',
                'permanent_address'       => 'required|string|max:255',
                'local_guardian'          => 'required|string|max:255',
                'state_belong'            => 'required|string|max:255',
                'whatsapp_mobile'         => 'required|string|max:115',
                'alternate_mobile'        => 'required|string|max:115',
