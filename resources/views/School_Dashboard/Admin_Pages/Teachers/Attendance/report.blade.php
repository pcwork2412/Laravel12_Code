            ...
            <div class="attendance-card">
                ...
                <div class="p-4">
                    ...
                    <div class="month-selector">
                        ...
                        <form method="GET" action="{{ route('teacher_attendance.show', $teacher->id) }}" id="monthForm">
    ...
    <script>
        document.getElementById('printReportBtn').addEventListener('click', () => {
            try {
                ...
                doc.text('Teacher Monthly Attendance Report', 105, 15, {
                    align: 'center'
                });
                doc.setFontSize(10);
                ...
                doc.text('School Management System', 105, pageHeight - 10, {
                    align: 'center'
                });
                doc.text(`Page 1`, 196, pageHeight - 10, {
                    align: 'right'
                });

                // Save PDF
                doc.save(`Teacher_Attendance_${teacherName.replace(/\s+/g, '_')}_${selectedMonth}.pdf`);
