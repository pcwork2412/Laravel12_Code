            ...
            <div class="card-body">
                <div class="row d-flex justify-content-start align-items-center mb-3">
                    <div class="col-md-3 mb-2">
                            ...
                            <input type="date" max="{{ date('Y-m-d') }}" id="dateFilter" name="attendance_date" class="form-control">
                    </div>
                    <!-- Table -->
                    ...
                    <form id="editAttendanceForm">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="mb-3">
                                    <label for="editTecherName" class="form-label">Techer Name</label>
                                    <input type="text" class="form-control" id="editTecherName" name="teacher_name"
                                        readonly>
                                </div>
    ...
    @push('scripts')
        ...
        <script>
            ...
            //         ],
                ...
                // ✅ Default current date set kar do
                let today = new Date().toISOString().slice(0, 10);
                $('#dateFilter').val(today);

                // ✅ Jab date change ho → table reload ho
                ...
                $(document).on('click', '.editBtn', function() {
                    ...
                    $.ajax({
                        url: `/teacher_attendance/${id}/edit`,
                        type: 'GET',
                        success: function(data) {
                            $('#editAttendanceId').val(data.id);
                            $('#editTecherName').val(data.teacher_name);
