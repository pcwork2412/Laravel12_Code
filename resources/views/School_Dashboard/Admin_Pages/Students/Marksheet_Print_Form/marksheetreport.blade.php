...
@section('content')
        ...
        <div class="card shadow-sm border-0 rounded-4">
            <div class="card-header bg-success">
                <h3 class="card-title mb-0 text-white fw-bold">
                    <i class="fa-solid fa-file-alt"></i> Marksheet Generation History
                </h3>
            </div>
    ...
    <div class="modal fade" id="allStudentsModal" tabindex="-1" data-bs-keyboard="false" data-bs-backdrop="static">
    ...
    <div class="modal fade" id="studentHistoryModal" tabindex="-1" data-bs-keyboard="false" data-bs-backdrop="static">
        <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header bg-success text-white">
                    <h3 class="modal-title">
    ...
    <script>
        $(document).ready(function() {
            ...
            var table = $('#historyTable').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route('students.marksheetHistoryData') }}",
                    type: 'GET',
                    data: function(d) {
                ...
                pageLength: 25,
                language: {
                    processing: '<i class="fa fa-spinner fa-spin fa-3x text-success"></i><br>Loading...'
                }
            });
            ...
            $('#resetFilter').click(function() {
                $('#filterClass, #filterSection').val('All').removeClass('border-success');
                table.draw();
            });
            ...
            $('#historyTable').on('click', '.view-student-history', function() {
                ...
                $.ajax({
                    url: `/admin/students/marksheet-history/details/${uid}`,
                    method: 'GET',
                                            ...
                                            <div class="row align-items-center">
                                                <div class="col-md-8">
                                                    <h4 class="text-success mb-2">
                                                        <i class="fa fa-users"></i> Classwise Marksheet Generation
                                                    </h4>
                                                    <p class="mb-1">
                                                        <strong>Class:</strong> <span class="badge bg-success">${className}</span>
                                                ...
                                                <div class="col-md-4 text-end">
                                                    <button class="btn btn-success btn-sm view-all-students-in-modal" 
