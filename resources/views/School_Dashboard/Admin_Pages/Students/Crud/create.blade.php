        ...
        <div class="modal-content shadow-sm rounded-3 border-0"
            ...
            <div class="modal-header bg-primary text-white border-0 rounded-top-3">
                <h3 class="modal-title" id="studentModalLabel">
                 ...
                 <a href="{{route("students.index")}}" class="btn btn-white shadow-sm">
                            <i class="fa fa-list me-2"></i>View Student List
                        </a>
            </div>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        <div class="">
                            <label>Section:</label>
                            <select id=""
                             name="section_name" class="globalSectionSelect form-control" required>
                    ...
                    <div class="col-md-6">
                        <div class="">
                            <label for="alternate_mobile" class="form-label fw-semibold">Alternate Mobile
                                No.</label>
                            <input type="number" id="alternate_mobile" value="{{ old('alternate_mobile') }}"
