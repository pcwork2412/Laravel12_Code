    ...
    <div class="container my-5">
        <div class="card shadow-sm">
            <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                <h3 class="mb-0"><i class="bi bi-pencil-square me-2"></i> Allot Students Marks</h3>
                <a href="{{ route('marks.index') }}" class="btn btn-light">
                    <i class="fas fa-list"></i> See Marks List
                </a>
            </div>
            <div class="card-body">
