        ...
        <div class="card shadow-sm">
            <div class="card-header bg-primary text-white">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('students.index') }}" class="btn btn-light btn-sm"><i
                            class="bi bi-arrow-left-circle me-1"></i>Back to Students List</a>
                </div>
            </div>
            <div class="card-body">
                ...
                <form action="{{ route('students.import.data') }}" method="POST" enctype="multipart/form-data"
                    ...
                    <div class="col-12 d-flex justify-content-between">
                        <div class="mb-4">
                            <a href="{{asset('pos/import/student_excel_template(teacher).xlsx')}}" class="btn btn-outline-success btn-sm rounded-pill px-4 shadow-sm">
