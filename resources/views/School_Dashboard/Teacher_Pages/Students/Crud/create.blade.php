        ...
        <div class="modal-content shadow-sm rounded-3 border-0"
            ...
            <div class="modal-body p-4">
                ...
                <div class="row g-3">
                        ...
                        <div class="">
                            ...
                            <select id="promoted_class_name" name="promoted_class_name"
                                ...
                                {{-- @foreach ($classes as $class) --}}
                                    <option value="{{ $classes->class_id }}">{{ $classes->promoted_class_name }}</option>
                                {{-- @endforeach --}}
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="">
                            <label>Section:</label>
                               <select id=""
                             name="section_name" class="section_name form-select" required>
                                <option value="">Select Section</option>
                                  {{-- @foreach ($classes as $section) --}}
                                    <option value="{{ $classes->section_id }}">{{ $classes->section }}</option>
                                {{-- @endforeach --}}
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="">
                            <label for="mother_name" class="form-label fw-semibold">Mother's
                                Name </label>
                            <input type="text" id="mother_name" value="{{ old('mother_name') }}" name="mother_name"
                                class="form-control rounded-3" placeholder="Enter Mother's Name">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="">
                            <label for="father_name" class="form-label fw-semibold">Father's
                                Name </label>
                            <input type="text" id="father_name" value="{{ old('father_name') }}" name="father_name"
                                class="form-control rounded-3" placeholder="Enter Father's Name">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="">
                            <label for="guardian_name" class="form-label fw-semibold">Guardian's Name</label>
                            <input type="text" id="guardian_name" value="{{ old('guardian_name') }}"
                                name="guardian_name" class="form-control rounded-3" placeholder="Enter Guardian's Name">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="">
                            ...
                            <input type="text" id="father_occupation_income"
                                ...
                                class="form-control rounded-3" placeholder="Enter Father's Occupation & Annual Income">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="mb-3">
                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        <div class="">
                            <label for="present_address" class="form-label fw-semibold">Present Address (with PIN
                                code)</label>
                    ...
                    <div class="col-md-6">
                        <div class="">
                            <label for="permanent_address" class="form-label fw-semibold">Permanent Address (with
                                PIN
                                code)</label>
                            <input type="text" id="permanent_address" value="{{ old('permanent_address') }}"
                                name="permanent_address" class="form-control rounded-3"
                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        <div class="">
                            <label for="whatsapp_mobile" class="form-label fw-semibold">WhatsApp Mobile
                                No.</label>
                    ...
                    <div class="col-md-6">
                        <div class="">
                            <label for="alternate_mobile" class="form-label fw-semibold">Alternate Mobile
                                No.</label>
                            <input type="text" id="alternate_mobile" value="{{ old('alternate_mobile') }}"
                                name="alternate_mobile" class="form-control rounded-3"
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            <label for="email_id" class="form-label fw-semibold">Email
                                Id</label>
                            <input type="email" id="email_id" value="{{ old('email_id') }}" name="email_id"
                                class="form-control rounded-3" placeholder="Enter Email Id">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-6">
                        <div class="">
                            ...
                            <input type="text" id="aadhaar_number" value="{{ old('aadhaar_number') }}"
                                name="aadhaar_number" class="form-control rounded-3" placeholder="Enter Aadhaar Number">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="">
                            <label for="ration_card_type" class="form-label fw-semibold">Ration Card Type</label>
                            <select name="ration_card_type" id="ration_card_type"class="form-select rounded-3">
                                <option value="" disabled selected>Select Ration Card
                                    Type</option>
                                <option value="APL" {{ old('ration_card_type') == 'APL' ? 'selected' : '' }}>
                                    APL</option>
                                <option value="BPL" {{ old('ration_card_type') == 'BPL' ? 'selected' : '' }}>
                                    BPL</option>
                                <option value="Antyodaya" {{ old('ration_card_type') == 'Antyodaya' ? 'selected' : '' }}>
                                    Antyodaya</option>
                            </select>
                        </div>
                    </div>
                        ...
                        <div class="mb-3">
                            ...
                            <select name="physically_handicapped" id="physically_handicapped"
                                ...
                                <option value="" disabled selected>Select Disability
                                    Status</option>
                                <option value="Yes" {{ old('physically_handicapped') == 'Yes' ? 'selected' : '' }}>
                                    Yes</option>
                                <option value="No" {{ old('physically_handicapped') == 'No' ? 'selected' : '' }}>
                                    No</option>
                            </select>
                        </div>
                    </div>
                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        <div class="">
                            <label for="account_holder_name" class="form-label fw-semibold">Account Holder
                                Name</label>
                            <input type="text" id="account_holder_name" value="{{ old('account_holder_name') }}"
                                name="account_holder_name" class="form-control rounded-3"
                    ...
                    <div class="col-md-6">
                        <div class="">
                            <label for="bank_name_branch" class="form-label fw-semibold">Bank
                                Name & Branch</label>
                            <input type="text" id="bank_name_branch" value="{{ old('bank_name_branch') }}"
                                name="bank_name_branch" class="form-control rounded-3"
                    ...
                    <div class="col-md-6">
                        <div class="">
                            ...
                            <input type="text" id="account_number" value="{{ old('account_number') }}"
                                name="account_number" class="form-control rounded-3" placeholder="Enter Account Number">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="">
                            <label for="ifsc_code" class="form-label fw-semibold">IFSC
                                Code</label>
                            <input type="text" id="ifsc_code" value="{{ old('ifsc_code') }}" name="ifsc_code"
                                class="form-control rounded-3" placeholder="Enter IFSC Code">
                        </div>
                    </div>
                </div>
...
@push('scripts')
    ...
    <script src="{{ asset('pos/assets/js/CustomJS/Students/Crud/createajax.js') }}"></script>
@endpush
