...
<div class="card  rounded-4 border-0">
    <div class="card-body p-4">
        <div class="row align-items-center">
            ...
            <div class="col-md-3 text-center mb-3 mb-md-0">
                @if (isset($student) && $student->image)
                    <img src="{{ asset('storage/' . $student->image) }}" class="rounded-circle border shadow-sm" style="width: 120px; height: 120px; object-fit: cover;">
                @else
                ...
                @endif
                <h3 class="mt-3 text-dark">{{ $student->student_name }}</h3>
            ...
            <div class="col-md-5">
                <ul class="list-group list-group-flush">
                    <li class="list-group-item px-0 py-2"><strong>Class Name:</strong> {{ $student->promoted_class_name }}</li>
                    <li class="list-group-item px-0 py-2"><strong>Section:</strong> {{ $student->section }}</li>
                    <li class="list-group-item px-0 py-2"><strong>Date of Registration:</strong> {{ $student->created_at->format('d M Y') }} <small class="text-muted">({{ $student->created_at->diffForHumans() }})</small></li>
            ...
            <div class="col-md-4">
                <ul class="list-group list-group-flush">
                    <li class="list-group-item px-0 py-2"><strong>Phone:</strong> <a href="tel:{{ $student->whatsapp_mobile }}">{{ $student->whatsapp_mobile }}</a></li>
                    <li class="list-group-item px-0 py-2"><strong>Email:</strong> <a href="mailto:{{ $student->email_id }}">{{ $student->email_id }}</a></li>
                    <li class="list-group-item px-0 py-2"><strong>Address:</strong> {{ $student->permanent_address }}</li>
        ...
        <hr>
        <div class="text-end">
            <a href="#" data-bs-toggle="modal" data-target="#profile_info" class="btn btn-sm btn-outline-danger">
