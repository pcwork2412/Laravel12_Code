...
@section('content')
    ...
    <div class="jumbotron jumbotron-fluid page-header position-relative mb-5 " style="margin-bottom: 50px;">
        <div class="container text-center py-5">
            <h1 class="text-white display-1">Photo Gallery</h1>
   ...
   <section class="gallery-block compact-gallery py-5">
    <div class="container">
        ...
        <div class="col-sm-6 col-md-4 col-lg-3 item img-box">
            <a class="lightbox d-block position-relative" href="{{ asset('storage/'.$img->image_path) }}">
                <img class="img-thumbnail image" src="{{ asset('storage/'.$img->image_path) }}" alt="Gallery Image">
