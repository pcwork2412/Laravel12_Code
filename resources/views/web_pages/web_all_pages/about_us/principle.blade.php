...
@section('content')
    ...
    >
      <div class="container text-center py-5">
        <h1 class="text-white display-3">Principle`s Profile</h1>
        <div class="d-inline-flex text-white mb-5">
          <p class="m-0 text-uppercase">
            <a class="text-white" href="{{route('web.index')}}">Home</a>
          </p>
          <i class="fa fa-angle-double-right pt-1 px-3"></i>
          <p class="m-0 text-uppercase">Principle`s Profile</p>
        </div>
      </div>
    </div>
    <!-- Header End -->

    <!-- Principle Content Section Start -->
    <div class="container">
      <div class="row">
        <div class="col-md-4 ">
          <img src="{{asset('website/assets/img/teacher/team-4.jpg')}}" alt="" class="img-fluid img-thumbnail" />
        </div>
        <div class="col-md-8">
          <h3 class="about-head">From The Desk of Principle</h3>
          <p class="about-para pl-5">
            "The best schools don’t just teach—they awaken minds, build character and ignite dreams."
          </p>
          <p class="about-para">
