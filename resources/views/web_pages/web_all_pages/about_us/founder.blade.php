...
@section('content')
    ...
    <div class="jumbotron jumbotron-fluid page-header position-relative mb-5 " style="margin-bottom: 50px;">
        <div class="container text-center py-5">
            <h1 class="text-white display-3">Founder Chairman`s Profile</h1>
            <div class="d-inline-flex text-white mb-5">
                <p class="m-0 text-uppercase"><a class="text-white" href="{{route('web.index')}}">Home</a></p>
                <i class="fa fa-angle-double-right pt-1 px-3"></i>
                <p class="m-0 text-uppercase">Founder Chairman`s Profile</p>
            </div>
        </div>
    </div>
    <!-- Header End -->
    ...
    <!-- About Section Start -->
     <div class="container">
         <div class="row">
             <div class="col-md-4">
                 <img src="{{asset('website/assets/img/teacher/team-1.jpg')}}" alt="" class="img-fluid img-thumbnail text-center">
             </div>
                <div class="col-md-8">
                    <h3 class="about-head">Founder Chairman`s Profile</h3>
                    <p class="about-para">"Bring the best from the world and offer the best to the world"</p>
