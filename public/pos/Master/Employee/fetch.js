$(document).ready(function() {
  ...
  function fetchData() {
    $.ajax({
      url: "Master/Customer/load-table.php",
      type: "POST",
      dataType: "json",
      success: function(response) {
        ...
        $.each(data, function(index, value) {
          table.row.add([
            ...
            value.first_name,
            value.last_name,
            '<img src="Master/Customer/uploads/' + value.image + '" style="width:50px;height:50px;border:2px solid gray;border-radius:8px;object-fit:cover">',
            value.email,
            value.country,
            value.gender,
  ...
  $("#myTable").on("click", ".editBtn", function() {
    var id = $(this).val();
    $.ajax({
      url: "Master/Customer/singleupdate.php",
      type: "POST",
      dataType: "json",
      data: {
        id: id
      ...
      success: function(response) {
        ...
        $("#editForm .preview_img").attr("src", "Master/Customer/uploads/" + data.image + "");
  ...
  $("#editForm").on("submit", function(e) {
    ...
    e.preventDefault();
    $.ajax({
      url: "Master/Customer/update.php",
      type: "POST",
      data: new FormData(this),
      contentType: false,
      cache: false,
  ...
  $("#myTable").on("click", ".deleteBtn", function() {
    if(confirm("Are you sure you want to delete this user?")) {
      ...
      $.ajax({
        url: "Master/Customer/delete.php",
        type: "POST",
        dataType: "json",
        data: {
          id,
