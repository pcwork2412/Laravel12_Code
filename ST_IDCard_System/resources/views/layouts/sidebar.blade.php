        ...
        <div id="sidebar-menu" class="sidebar-menu">
            <ul>
                   ...
                   <li class="submenu">
                    ...
                    <ul style="display: none;">
                        <!-- Add student-related links here -->
                         <li>
                   <a href="{{ url('class_name') }}"><i class="la la-graduation-cap me-1"></i> <span>Add Classes Master </span></a>
                </li>
                        <li>
                            <a href="{{ url('school_name') }}">
                                <i class="fa-solid fa-building "style="font-size:18px;"></i>&nbsp;&nbsp;Add School Master  
                            </a>
                    ...
                    <ul style="display: none;">
                        ...
                        <li>
                            <a href="{{ route('students.index') }}">
                                <i class="fa-solid fa-rectangle-list "style="font-size:18px;"></i>&nbsp;&nbsp;Students List
                            </a>
                        </li>
                         <li>
                            <a href="{{ route('students.import.form') }}">
                                <i class="fa-solid fa-file-excel "style="font-size:18px;"></i>&nbsp;&nbsp;Import Students
                            </a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="submenu">
                    ...
                    <ul style="display: none;">
                        <li>
                            <a href="{{ route('students.singleIdForm') }}"><i class="fa-solid fa-user"style="font-size:18px;"></i>&nbsp;&nbsp;Generate Individual</a>
                        </li>
                        <li>
                            <a href="{{ route('students.classwiseIdForm') }}"><i class="fa-solid fa-users"style="font-size:18px;"></i>&nbsp;&nbsp;Generate Class Wise</a>
                        </li>
                    </ul>
                </li>
                  {{-- ID CARD TEMPLATE --}}
                ...
                <li class="submenu">
                    ...
                    <ul style="display: none;">
                        <li>
                            <a href="{{ route('marks.create') }}"><i class="fa-solid fa-circle-plus fa-1x"style="font-size:18px;"></i>&nbsp;&nbsp;Add Marks</a>
                        </li>
                        <li>
                            <a href="{{ route('marks.index') }}"><i class="fa-solid fa-list fa-1x"style="font-size:18px;"></i>&nbsp;&nbsp;Marks List</a>
                        </li>
                        {{-- <li>
                ...
                <li class="submenu">
                    ...
                    <ul style="display: none;">
                        <li>
                            <a href="{{ route('marksheet.student.form') }}"><i class="fa-solid fa-user fa-1x"style="font-size:18px;"></i>&nbsp;&nbsp;Individual Marksheet</a>
                        </li>
                        <li>
                            <a href="{{ route('marksheet.form') }}"><i class="fa-solid fa-users fa-1x"style="font-size:18px;"></i>&nbsp;&nbsp;Classwise Marksheet</a>
                        </li>
                ...
                <li class="submenu">
                    ...
                    <ul style="display: none;">
                        <li>
                            <a href="{{ route('gallery.index') }}"><i class="fa-solid fa-circle-plus fa-1x"style="font-size:18px;"></i>&nbsp;&nbsp;Add Image</a>
                        </li>
                    </ul>
                </li>
            </ul>
